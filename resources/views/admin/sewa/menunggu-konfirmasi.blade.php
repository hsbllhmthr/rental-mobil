...
@section('title', 'Sewa Menunggu Konfirmasi')
...
@section('content')
    ...
    <div class="page-header">
        <h1 class="page-title">Sewa Menunggu Konfirmasi</h1>
    </div>
    ...
    <a href="#" class="link-to-detail"
       ...
       data-kk="{{ $rental->user->foto_kk ? asset('storage/' . $rental->user->foto_kk) : '' }}">
        {{ $rental->user->name ?? 'User Dihapus' }}
                            ...
                            <div class="status-dropdown">
                                ...
                                <div class="dropdown-menu">
                                    ...
                                    <form action="{{ route('admin.sewa.update_status', $rental->id) }}" method="POST">
                                        ...
                                        <button type="submit" class="dropdown-item">Menunggu Konfirmasi</button>
                                    </form>
                                    <form action="{{ route('admin.sewa.update_status', $rental->id) }}" method="POST">
                                        @csrf
                    ...
                    @empty
                    <tr>
                        <td colspan="9" style="text-align: center;">Tidak ada data sewa yang menunggu konfirmasi.</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
