...
<body>
    ...
    <div class="page-container">
            ...
            <div class="footer-content">
                ...
                <div class="footer-column">
                    ...
                    <div class="social-icons">
                        <a href="https://www.instagram.com/trimanunggalrentcar/" aria-label="Instagram"><i class="fa-brands fa-instagram"></i></a>
                        <a href="https://wa.me/6281355811336?" aria-label="WhatsApp"><i class="fa-brands fa-whatsapp"></i></a>
        ...
        <div id="status-modal" class="modal-overlay">
           ...
           <div class="modal-content text-center">
               ...
               <button class="btn-primary close-btn" style="padding: 10px 30px; margin: 20px auto 0;">Oke</button>
        ...
        <div id="login-modal" class="modal-overlay">
            ...
            <div class="modal-content">
                ...
                @if (session()->has('login_error'))
                    ...
                    <div style="color: #dc3545; text-align: center; margin-bottom: 15px; font-size: 14px; background-color: #f8d7da; padding: 10px; border-radius: 8px;">
                ...
                <form action="{{ route('login.submit') }}" method="POST">
                    ...
                    <div class="form-group">
                        ...
                        <input type="email" id="login_email" name="email" placeholder="Masukkan Alamat Email" value="{{ old('email') }}" required>
            ...
            <span id="togglePassword" 
                ...
                <i class="fa fa-eye"></i>
                    ...
                    <div style="text-align: right; margin-top: 5px; margin-bottom: 15px;">
                        ...
                        <a href="{{ route('password.request') }}" style="font-size: 13px; color: #118AEC; text-decoration: none;">Lupa Password?</a>
    ...
    if (togglePassword && passwordInput) {
        ...
        togglePassword.addEventListener("click", function () {
            ...
            this.innerHTML = type === "password" 
                ...
                // Logika untuk menampilkan modal sukses registrasi
                ...
                // Logika untuk membuka kembali modal login jika ada error
                ...
                // Logika untuk menampilkan modal status generik
    ...
    <a href="https://wa.me/6281355811336?text={{ urlencode('Halo, saya ingin bertanya.') }}" 
       target="_blank" 
       class="whatsapp-fab" 
